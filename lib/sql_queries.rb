...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_the_summed_amount
  "SELECT users.name AS name, SUM(pledges.amount) AS pledge FROM users
  INNER JOIN pledges
...
def selects_the_category_names_and_pledge_amounts_of_all_pledges_in_the_music_category
  "SELECT projects.category AS category, pledges.amount AS pledge FROM projects
  INNER JOIN pledges 
  ON projects.id = pledges.project_id
...
def selects_the_category_name_and_the_sum_total_of_the_all_its_pledges_for_the_books_category
  "SELECT projects.category AS category, SUM(pledges.amount) AS pledge FROM projects
  INNER JOIN pledges 
  ON projects.id = pledges.project_id
